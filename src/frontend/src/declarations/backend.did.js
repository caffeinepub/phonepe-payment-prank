...
export const MessageType = IDL.Variant({ 'text' : IDL.Text });
export const Time = IDL.Int;
export const Notification = IDL.Record({
  'id' : IDL.Nat64,
  'recipient' : IDL.Text,
  'audioData' : IDL.Opt(ExternalBlob),
  'isRead' : IDL.Bool,
  'sender' : IDL.Text,
  'message' : MessageType,
  'timestamp' : Time,
...
export const idlService = IDL.Service({
  ...
  'markNotificationAsRead' : IDL.Func([IDL.Nat64], [], []),
  'registerUser' : IDL.Func([IDL.Text, IDL.Text], [], []),
  'saveCallerUserProfile' : IDL.Func([UserProfile], [], []),
  'sendAudioNotification' : IDL.Func(
      [IDL.Text, IDL.Text, ExternalBlob],
      [],
      [],
    ),
  'sendTextNotification' : IDL.Func([IDL.Text, IDL.Text], [], []),
});
...
export const idlFactory = ({ IDL }) => {
  ...
  const MessageType = IDL.Variant({ 'text' : IDL.Text });
  const Time = IDL.Int;
