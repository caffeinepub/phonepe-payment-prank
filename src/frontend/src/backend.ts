...
import type { ExternalBlob as _ExternalBlob, MessageType as _MessageType, Notification as _Notification, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getUserNotifications(arg0: string): Promise<Array<Notification>> {
        if (this.processError) {
            try {
    ...
    async sendAudioNotification(arg0: string, arg1: string, arg2: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.sendAudioNotification(arg0, arg1, await to_candid_ExternalBlob_n20(this._uploadFile, this._downloadFile, arg2));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async sendTextNotification(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.sendTextNotification(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_Notification_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Notification): Promise<Notification> {
...
async function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        audioData: record_opt_to_undefined(await from_candid_opt_n13(_uploadFile, _downloadFile, value.audioData)),
        isRead: value.isRead,
        sender: value.sender,
        message: from_candid_MessageType_n15(_uploadFile, _downloadFile, value.message),
...
async function from_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Notification>): Promise<Array<Notification>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Notification_n11(_uploadFile, _downloadFile, x)));
}
